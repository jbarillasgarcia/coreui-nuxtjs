...
<script>
    import CardLine1ChartExample from '@/components/dashboardDemo/CardLine1ChartExample';
    import CardLine2ChartExample from '@/components/dashboardDemo/CardLine2ChartExample';
    import CardLine3ChartExample from '@/components/dashboardDemo/CardLine3ChartExample';
    import CardBarChartExample from '@/components/dashboardDemo/CardBarChartExample';
    import MainChartExample from '@/components/dashboardDemo/MainChartExample';
    import SocialBoxChartExample from '@/components/dashboardDemo/SocialBoxChartExample';
    import CalloutChartExample from '@/components/dashboardDemo/CalloutChartExample';
    import { Callout } from '@coreui/vue';

    import DashboardDemoPerimeter from '@/perimeter/DashboardDemoPerimeter';

    export default {
        name: 'dashboard',
        middleware: 'authenticated',
        perimeters: [
            DashboardDemoPerimeter
        ],
        components: {
            Callout,
