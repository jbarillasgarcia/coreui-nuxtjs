...
export default function (ctx, inject) {
  ...
  // local
  $auth.registerStrategy('local', new scheme_003d9a64($auth, {"endpoints":{"login":{"url":"auth","method":"post","propertyName":"data.token"},"logout":false,"user":{"url":"me","method":"get","propertyName":"data"}},"_name":"local"}))
